...
- \<Image\>Traditional Page Lifecycle showing request and response between client and web server

- \<Image\>SPA Page Lifecycle showing request and response between client and web server
...
- \<Image\>Single Page Application diagram with multiple templates loaded into a single page
- \<Image\>Traditional page application with multiple pages to be loaded
